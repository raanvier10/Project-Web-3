...
const translations = {
  en: {
    ...
    testi1_text: "\"Alhamdulillah, after joining EFA for 3 months, I can confidently speak English. The teaching methods are easy to understand and the learning environment is very comfortable for akhwat.\"",
    testi1_role: "Alumni Batch 12",
    testi2_text: "\"My TOEFL score increased from 450 to 570 after joining EFA's program. The instructors are experienced and supportive. Highly recommended!\"",
    testi2_role: "Alumni Batch 10",
    testi3_text: "\"EFA is not just a course, but also a community. I made new friends who support each other in learning English. An amazing experience!\"",
    testi3_role: "Alumni Batch 15",
  ...
  id: {
    ...
    testi1_text: "\"Alhamdulillah, setelah ikut EFA selama 3 bulan, saya bisa percaya diri berbicara bahasa Inggris. Metode pengajarannya sangat mudah dipahami dan lingkungan belajarnya sangat nyaman untuk akhwat.\"",
    testi1_role: "Alumni Batch 12",
    testi2_text: "\"TOEFL score saya naik dari 450 ke 570 setelah mengikuti program EFA. Pengajarnya sangat berpengalaman dan supportif. Highly recommended!\"",
    testi2_role: "Alumni Batch 10",
    testi3_text: "\"EFA bukan sekadar kursus, tapi juga komunitas. Saya mendapat teman-teman baru yang saling mendukung dalam belajar bahasa Inggris. Pengalaman yang luar biasa!\"",
    testi3_role: "Alumni Batch 15",
