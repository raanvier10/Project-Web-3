            ...
            <div class="float-card h-full">
                ...
                <div class="space-y-3.5 mb-5">
                    ...
                    <div class="flex justify-between items-center">
                        ...
                        <span class="inline-flex items-center px-2.5 py-1 rounded-full text-[10px] font-bold uppercase {{ $registration->coursePackage->category === 'kids' ? 'text-purple-700' : ($registration->coursePackage->category === 'teens' ? 'text-blue-700' : 'text-primary-700') }}" style="background: {{ $registration->coursePackage->category === 'kids' ? 'linear-gradient(135deg, #F3E8FF, #E9D5FF)' : ($registration->coursePackage->category === 'teens' ? 'linear-gradient(135deg, #DBEAFE, #BFDBFE)' : 'linear-gradient(135deg, #FFE0EC, #FFC2D9)') }};">
